...
export default function ChatAdmin(props) {
    ...
    const avatar = 'https://i.imgur.com/cIRFqAL.png';
    ...
    const sendMessage = async (type) => {
        ...
        let res = await dispatch(
            sendMessages({ clientId: senderID, senderId: 1, message: input, type: type, productId: '' }),
        );
    ...
    return (
        <div className="">
            ...
            <div className="bg-white p-2 d-flex align-items-center border-bottom">
                <img src={avatar} className="rounded-circle" alt="" style={{ width: '40px', height: '40px' }} />
            ...
            {/* Chat Content */}
            <div className="chat-content p-3 overflow-auto flex-grow-1" style={{ height: 'calc(80vh - 128px)' }}>
                        ...
                        >
                            ...
                            <div
                                className={`text-end text-xs mt-1 ${
                                    msg.senderId !== 2 ? 'text-white' : 'text-secondary'
                                }`}
                            >
            ...
            <SearchProductModal senderID={senderID} show={showModal} handleClose={() => setShowModal(false)} />
        </div>
    );
}
