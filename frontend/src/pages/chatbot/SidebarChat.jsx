...
function SidebarChat() {
    ...
    useEffect(() => {
        ...
        const sorted = _conversations.sort((a, b) =>
            new Date(b.time === "đang hoạt động" ? Date.now() : lastMessages.find(m => m.senderId === b.id)?.timestamp || 0) -
            new Date(a.time === "đang hoạt động" ? Date.now() : lastMessages.find(m => m.senderId === a.id)?.timestamp || 0)
        );
                                ...
                                {conversations.map((chat) => (
                                    ...
                                    >
                                        ...
                                        <div className="ms-2 overflow-hidden">
                                            ...
                                            <div className={`text-truncate small ${chat.message && chat.state === 0 ? 'fw-semibold text-dark' : 'text-secondary'}`}>
