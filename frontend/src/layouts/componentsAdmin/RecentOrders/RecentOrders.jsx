        ...
        <div className="bg-white w-full rounded-3xl shadow-md p-12 mt-8">
            ...
            <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                    <thead>
                        <tr>
                            <th className={cx('table-header', 'w-1/5')}>ORDER_ID</th>
                            <th className={cx('table-header', 'w-1/5')}>ORDER_DATE</th>
                            <th className={cx('table-header', 'w-1/3')}>CUSTOMER_NAME</th>
                            <th className={cx('table-header', 'w-1/5')}>ORDER_STATUS</th>
                            <th className={cx('table-header', 'w-1/5')}>TOTAL</th>
                        </tr>
                    </thead>
